"""
Django settings for mashujaahub project.
...
SECRET_KEY = '!!c28a@l@vbp=k-^&5gx-4n5#v^@^5jqq!a$&w3q6^l5vx_0vg'
...
WSGI_APPLICATION = 'mashujaahub.wsgi.application'
